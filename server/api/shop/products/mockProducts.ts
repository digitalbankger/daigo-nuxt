export const mockProducts = [
  {
    ...
    shortDescription: "Когда вы знаете, что впереди интенсивный день, высокая интеллектуальная или повседневная нагрузка, организм можно поддержать заранее.",
    fullDescription: "Evolution 10 + Mg — комплексная формула на метабиотической основе Daigo с магнием, L-теанином и витаминами B6, B9, B12 и K2. Она создана для поддержки нервной системы, энергетического обмена и внутренней среды организма в периоды повышенной нагрузки.",
    price: 9480,
    originalPrice: 11880,
    oldPrice: 11880,
    sort: 0,
    ...
    isActive: true,
    images: [
      { image_url: "/images/evolution/hero-main.webp", is_primary: true, display_order: 0 },
      { image_url: "/images/evolution/gallery-floating.webp", is_primary: false, display_order: 1 },
      { image_url: "/images/evolution/gallery-three.webp", is_primary: false, display_order: 2 },
      { image_url: "/images/evolution/gallery-hand.webp", is_primary: false, display_order: 3 },
      { image_url: "/images/evolution/gallery-many.jpg", is_primary: false, display_order: 4 }
    ],
    // faq: {
    //   items: [
    //     { q: "Для чего нужен витамин K2?", a: "Витамин K2 входит в функциональную формулу Evolution 10 + Mg." },
    //     { q: "Для чего нужен витамин K2?", a: "Витамин K2 входит в функциональную формулу Evolution 10 + Mg." },
    //     { q: "Для чего нужен витамин K2?", a: "Витамин K2 входит в функциональную формулу Evolution 10 + Mg." },
    //     { q: "Для чего нужен витамин K2?", a: "Витамин K2 входит в функциональную формулу Evolution 10 + Mg." },
    //     { q: "Для чего нужен витамин K2?", a: "Витамин K2 входит в функциональную формулу Evolution 10 + Mg." },
...
Вода, метаболиты 16 штаммов молочнокислых бактерий рода Lactobacillus: L. curvatus (BSC 001), L. curvatus (BSC 002), L. casei (BSC 003), L. casei (BSC 004), L. acidophilus (BSC 005), L. acidophilus (BSC 006), L. plantarum (BSC 007), L. plantarum (BSC 008), L. plantarum (BSC 009), L. fermentum (BSC 010), L. salivarius (BSC 011), L. salivarius (BSC 012), L. brevis (BSC 013), L. brevis (BSC 014), L. rhamnosus (BSC 015), L. rhamnosus (BSC 016); регуляторы кислотности: молочная кислота и лимонная кислота; витамин K2.</p>
    ...
    // Спорт бокс
    {
      ...
      combo: {
        title: 'Принцип действия',
        image: '/media-s3/products/sport-box/principles.png',
        text: `
          <p class="font-medium">Daigo Brainy</p>
      ...
      actionPrinciple: {
        title: '',
        image: '/media-s3/products/sport-box/principles-2.png',
        imagePosition: 'left',
        text: `
      ...
      effect: {
        title: 'Эффект',
        image: '/media-s3/products/sport-box/effect.png',
        imagePosition: 'right',
        content: `
          <p class="font-medium">Daigo Brainy</p>
...
при информационных и психоэмоциональных перегрузках, способствует профилактике тревожности и депрессии и помогает более быстрому засыпанию, снижает метеочувствительность.
      ...
      effectCombo: {
        title: '',
        image: '/media-s3/products/sport-box/effect-2.png',
        imagePosition: 'left',
        content: `
          <p class="font-medium">Daigo Jointic</p>
...
L-лейцин 52,5 мг;  L-аргинин 52,5 мг; Пальмитоилэтаноламид 325 мг; Липолитические ферменты (липазы) 20 000 МЕ; Витамин С 50 мг; Бор 662,5 нг; Марганец 2 мг;  Хром 50 нг.</p>
        ...
        `,
        image: '/media-s3/products/sport-box/sostav.png',
      },
      compositionCombo: {
        title: '',
        image: '/media-s3/products/sport-box/sostav-2.png',
        imagePosition: 'left',
        content: `
          <p class="font-medium">Daigo Lux</p>
...
<p class="">Очищенный рыбий жир, Омега-3 жирные кислоты (эйкозапентаеновая кислота, докозагексаеновой кислота), витамин А, витамин D, эмульгатор — глицерин растительный, оболочка капсулы — желатин (из рыбьего жира).</p>
      ...
      productionSection: {
        ...
        topImage: '/media-s3/products/tamotsu/prod-gen.png',
        bottomImages: [
          '/media-s3/products/sport-box/prod-1.png',
          '/media-s3/products/sport-box/prod-2.png',
        ]
        },
      },
      images: [
            {
                image_url: "/media-s3/products/sport-box/product-1.png",
                is_primary: true,
                display_order: 0
            },
