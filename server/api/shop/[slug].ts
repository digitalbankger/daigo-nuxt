...
<br><br>Регуляторы кислотности: молочная кислота и лимонная кислота; витамин K2.</p>
    ...
    // Сертификат 10 000
    {
      ...
      shortDescription:
        'Сделайте свой вклад в здоровье близких и получайте благодарности на протяжении всего 2025 года. Сертификат можно применить на покупку любого товара на нашем сайте. На сертификаты не распространяется скидка по промокоду "WELCOME10".',
