  ...
  <div class="gift-progress rounded-2xl border border-primary/15 bg-white px-4 py-4 md:px-5 md:py-5 shadow-[0_12px_40px_rgba(21,152,194,0.08)]">
    <div class="flex items-center gap-3 md:gap-4">
      <div class="gift-progress__image-wrap shrink-0">
        <img :src="giftImageSrc" :alt="giftName" class="gift-progress__image">
      </div>

      <div class="min-w-0 flex-1">
        <div class="flex flex-wrap items-center gap-2 mb-1.5">
          <span class="inline-flex items-center rounded-full bg-primary/10 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-primary">
        ...
        <div class="mt-3 flex items-center justify-between gap-3 text-[11px] md:text-xs text-black/45">
