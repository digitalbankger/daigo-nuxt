    ...
    <div class="relative flex items-center justify-between px-3 sm:px-6 py-2 sm:py-3">
      ...
      >
        <img
          ...
          loading="lazy"
        />
        <span class="text-sm sm:text-lg font-normal">Ваш персональный бонус уже активен - получить уже сейчас!</span>
      </NuxtLink>

      <!-- MOBILE -->
       <div class="flex flex-col items-center gap-2 w-full justify-center sm:hidden uppercase">
        <span class="text-sm sm:text-lg font-normal">Ваш персональный бонус уже активен</span>
      <NuxtLink
        to="/catalog"
