<template>
  <div v-if="ui.isHeadInformerVisible"
    ...
    <div class="relative flex items-center justify-center gap-4 px-3 sm:px-6 py-2 sm:py-2">
      ...
      <span class="text-sm sm:text-base text-center font-mont font-medium py-1.5">Функционал сайта может быть недоступен<br class="sm:hidden"> с 00:00 до 04:00 МСК</span>
      <!-- DESKTOP TEXT -->
      <!-- <NuxtLink
        to="/catalog"
