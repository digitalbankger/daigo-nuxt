  ...
  <nav class="py-6 mt-0 relative">
    <div class="w-full flex flex-row items-center justify-between py-2 gap-7 px-0 sm:px-2">
      ...
      <div class="flex flex-row items-center gap-6 shrink-0 text-xl text-black">
        ...
        <!-- Профиль: кнопка вместо NuxtLink -->
        <button
          type="button"
          aria-label="Профиль"
          class="hidden hover:text-primary text-black transition lg:flex flex-col items-center"
          ...
          >
            <span class="inline-flex items-center gap-1">
              ...
              <svg
                ...
                :class="isPartnersPopupOpen ? 'rotate-180' : ''"
                viewBox="0 0 10 6"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
    ...
    <div
      ...
      class="absolute right-0 sm:right-80 top-full-2 mt-2 z-50 bg-white border border-gray-100 rounded-lg shadow-lg text-base"
    >
      <!-- <button
        type="button"
        class="absolute -top-2 -right-2 w-5 h-5 rounded-full bg-gray-200 flex items-center justify-center text-xs"
        @click="closePartnersPopup"
      >
        ✕
      </button> -->
