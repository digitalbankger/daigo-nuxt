  ...
  <div class="w-full flex flex-row items-center justify-between py-2 gap-7 px-2">
    <div class="flex items-center gap-7 shrink-0">
      <NuxtLink to="/" aria-label="Главная">
        <img src="/logo.svg" alt="daigo logo" class="md:h-16" />
        <p class="text-[4px] md:text-[10px] text-[#454749] mt-1">С 1905 г. заботимся о вашем здоровье</p>
      </NuxtLink>

      <NuxtLink
        to="/catalog"
        class="hidden w-44 md:inline-flex justify-center items-center bg-primary text-white rounded-lg gap-2 py-3 px-6 text-xl font-normal transition duration-300 group hover:bg-primary/80"
      >
        <img
  ...
  <div class="flex flex-row items-center justify-between pt-3 pb-2 gap-7 px-2 overflow-x-auto no-scrollbar scroll-touch md:overflow-hidden ">
    <div class="flex items-center gap-7 shrink-0">
      <ul class="flex items-center gap-5 md:text-xl font-normal tracking-wide text-black">
        ...
        <li class="transition duration-300 hover:text-primary"><NuxtLink to="/about">О нас</NuxtLink></li>
        <li class="transition duration-300 hover:text-primary"><NuxtLink to="/articles">Статьи</NuxtLink></li>
