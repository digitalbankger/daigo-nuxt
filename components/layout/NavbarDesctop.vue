<template>
  ...
  <div class="w-full flex flex-row items-center justify-between py-2 gap-7 px-2">
    ...
    <div class="flex flex-row items-center gap-6 shrink-0 text-xl text-black">
      <a href="" class="text-lg flex flex-row items-center gap-2 me-0 md:me-3 transition duration-300 text-black hover:text-primary">
      ...
      <NuxtLink to="/profile" aria-label="Профиль" class="hidden hover:text-primary text-black transition md:flex flex-col items-center">
        <svg width="30" height="30" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
