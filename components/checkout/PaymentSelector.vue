...
const methods: M[] = [
  // 1 ряд
  {
    ...
    img: 'http://localhost:3000/images/oplata/sbp.png',
    layout: 'logo-only',
  },
  {
    value: 'installments',
    ...
    img: 'http://localhost:3000/images/oplata/dolyame.png',
    layout: 'text',
  },
  {
    value: 'credit',
    ...
    img: 'http://localhost:3000/images/oplata/tbank.png',
    layout: 'text',
  },
  // 2 ряд
  {
    ...
    img: 'http://localhost:3000/images/oplata/bankcard.png',
    layout: 'text',
  },
  {
    value: 'card_courier',
    ...
    img: 'http://localhost:3000/images/oplata/couriercard.png',
    layout: 'text',
  },
  {
    value: 'cash_courier',
    ...
    img: 'http://localhost:3000/images/oplata/couriercash.png',
    layout: 'text',
  },
]
