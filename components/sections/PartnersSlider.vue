...
const partners = [
  {
    logo: '/images/partners/logotip-PZ.png',
    name: 'Планета Здоровья',
    about: 'Крупная аптечная сеть: более 3 000 аптек в 60 регионах России.',
    link: 'https://planetazdorovo.ru/',
    description:
      'По итогам 2024 входит в ТОП-3 брендов фарм-ритейла России и пять раз подряд (2019–2024) становилась «Аптечной сетью года» по версии премии «Зелёный Крест».<br><br>Сегодня это федеральная сеть, ориентированная на современные тренды здорового образа жизни и качество поставок.'
  },
  {
  ...
  },
  {
    ...
    description:
      'Verba Mayr предлагает своим гостям программы омоложения и детокса по известной методике австрийского врача Франца Ксавьера Майера. <br><br>Мы на регулярной основе проводим обучающие мероприятия о Дайго для врачей центра.'
  },
  {
    ...
    description:
      'Благодаря коллективу из 600 врачей, в том числе из США, Израиля, Европы, Японии, диагностика и лечение проходят по современным американским и европейским протоколам. <br>Для пациентов это возможность получить доступ к лучшим мировым методикам лечения, не уезжая за рубеж.'
  },
  {
  ...
  },
  {
    ...
    about: '',
    description:
      '«Мать и дитя» сегодня — это 6 ультрасовременных высокотехнологичных госпиталей и 36 клиник, обладающих мощными диагностическими и терапевтическими ресурсами, в 27 городах России, более 7000 квалифицированных специалистов, знающих и любящих свою работу, а также уникальный спектр медицинских услуг для всей семьи.'
  },
  {
    logo: '/images/partners/bosco.png',
    name: 'Аптека Bosco',
    about: 'Аптека Bosco — премиальный аптечный бутик при Bosco Clinica в Петровском пассаже.',
    description:
      'В ассортименте представлены лекарственные препараты, БАДы, косметика, медицинская техника и товары для ухода. <br><br>Продукты Дайго доступны покупателям аптеки.'
  }
]
