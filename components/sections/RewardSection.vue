    ...
    <div class="relative !pl-[0%] sm:!pl-[8%]">
      ...
      >
        <SwiperSlide
          ...
          class="h-auto mb-5"
        >
          <RewardCard :reward="reward" @open="openReward" />
        </SwiperSlide>
      </Swiper>
      ...
      <div class="flex gap-2 absolute bottom-0 right-0 sm:right-0 z-20">
        <div
          ...
          :key="i"
          class="h-[2.5px] sm:h-[3px] w-4 sm:w-16 rounded-full transition-colors"
          :style="{
...
const rewards = [
  {
    ...
    description:
      'Номинация: «БАДы и оздоровительные пищевые добавки». Результат: Лауреат. SKU: Бренд Daigo.',
  },
  {
    ...
    description:
      'Номинация: «Лучшая продукция для косметолога». Результат: Лауреат 3 степени. SKU: Daigo Dermic.',
  },
  {
  ...
  // Новые награды из документа
  {
    ...
    description:
      'Номинация: «Продукты здорового питания. Продукт года». Результат: Золотая медаль. SKU: Daigo Evolution.',
  },
  {
    ...
    description:
      'Номинация: Продукт года. Результат: Золотая медаль. SKU: Daigo.',
  },
  {
    ...
    about:
      'Международная осенняя выставка продуктов питания, которая создаёт максимальные возможности для развития бизнеса: найти новых клиентов и партнёров, презентовать новинки, расширить экспортные возможности, изучить рынок. А для представителей торговых предприятий и предприятий общественного питания — это возможность найти новых поставщиков качественной продовольственной продукции.',
    description:
      'Номинация: Продукт года. Результат: Бронзовая медаль. SKU: Daigo. Эмблема за 2015 год отсутствует в хорошем качестве.',
  },
  {
    ...
    description:
      'Номинация: Лучший инновационный продукт. Результат: Золотая медаль. SKU: Daigo.',
  },
  {
    ...
    description:
      'Номинация: Без номинации. Результат: Лауреат. SKU: Daigo.',
  },
  {
    ...
    description:
      'Номинация: «Производство и реализация продуктов диетического питания, продуктов детского питания, продуктов спортивного питания, продуктов лечебного питания, продуктов здорового питания, витаминов, биоактивных добавок». Результат: Победитель. SKU: Бренд Daigo.',
  },
  {
    ...
    description:
      'Номинация: «Лучший ЗОЖ-бренд». Результат: Победитель. SKU: Бренд Daigo.',
  },
  {
    ...
    description:
      'Номинация: Без номинации. Результат: Победитель. SKU: Daigo.',
  },
  {
    ...
    description:
      'Номинация: «Ветеринарные препараты». Результат: Победитель конкурса новинок. SKU: Lactis zoo.',
  },
]
