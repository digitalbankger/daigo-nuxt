...
// здесь можно ничего не писать — баннер полностью статичный
</script>
  ...
  <section class="relative w-full overflow-hidden">
    <div
      class="banner-slide bg-[#242325] flex flex-col sm:flex-row items-center justify-between
             ...
             h-[360px] sm:h-[320px] lg:h-[500px]"
    >
      <img src="/images/gen-bf-mobile.png" class="sm:hidden block w-full absolute left-0 bottom-0" />
      <img src="/images/gen-bf.png" class="hidden sm:block w-full absolute left-0 bottom-0" />
      <!-- Левая часть: теги, заголовок, текст, кнопка -->
      <div class="w-full sm:max-w-[80%] lg:max-w-[60%]">

        <!-- Заголовок -->
        <img src="/icons/head.svg" class="w-full sm:w-[360px] sm:absolute sm:right-60 top-6" />

        <div class="absolute right-0 sm:right-60 ps-3 top-32 mt-2 sm:mt-0 sm:top-40 pt-1 space-y-6 w-[70%] sm:w-[260px]">
            <!-- Текст -->
            <div
      ...
      <!-- Правая часть: можно оставить пустой или картинку/объект -->
      <!-- Пример: картинка продукта -->
      <!--
      <div class="hidden sm:block sm:w-[40%] lg:w-[35%]">
        <img
