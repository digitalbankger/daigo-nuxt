...
const categories: Category[] = [
  { id: 6, image: '/images/promo.jpg', isPromo: true },
  { id: 0, title: 'Розыгрыш призов', image: '/images/categories/all.png', slug: 'konkurs' },
      ...
      <template v-for="category in categories" :key="category.id">
        <NuxtLink
          ...
          class="promo-card col-span-2 sm:col-span-2 lg:col-span-1 xl:col-span-2 
                bg-cover bg-top-left rounded-xl rounded-2.5xl px-5 sm:px-10 py-8 sm:py-12 lg:py-7 
                flex flex-row gap-3 relative overflow-hidden"
        >

          <!-- <img src="/icons/deal.svg" class="w-[90px] sm:w-[140px] absolute top-0 left-2 z-0"/> -->

          <div class="relative z-10 flex flex-col gap-3 w-[80%] sm:w-[70%] justify-center">
            <h3 class="xs-max:text-2xl text-[22px] sm:text-4xl font-normal !leading-[1.3em] text-white mb-1 sm:mb-6">
              Акции <br>и конкурсы Даиго
            </h3>
        ...
        <NuxtLink
          v-else
          :to="category.slug === 'konkurs'
            ? '/konkurs'
            : linkFor(category)
          "
          :style="
            category.slug === 'konkurs'
              ? { backgroundImage: 'url(/images/new-year/ny-gen-bonus-2.jpg)' }
              : undefined
          "
          class="
            relative overflow-hidden group
            bg-hoverbtn bg-cover bg-center
            border border-hoverbtn
            rounded-xl sm:rounded-2.5xl
            px-2.5 sm:px-6 py-3 sm:py-7
            flex flex-col justify-between items-start
            min-h-[180px] sm:min-h-[280px]
            transition-transform duration-300
            hover:shadow-productcard hover:no-underline
          "
          >
          <img
            v-if="category.slug !== 'konkurs'"
          ...
          <h3 
            ...
            :class="{
              'w-[86%] text-white text-xl sm:text-4xl mt-6': category.slug === 'konkurs',
          ...
          <img
            ...
            :class="category.slug === 'konkurs' ? 'w-[0px]' : 'w-[70%] sm:w-[60%]'"
          />
...
<style scoped>
.promo-card {
  background-image: url('/images/new-year/ny-gen-promo.jpg'); 
