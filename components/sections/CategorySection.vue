      ...
      <template v-for="category in categories" :key="category.id">
        <div
          ...
          class="col-span-2 sm:col-span-2 lg:col-span-1 xl:col-span-2 
             bg-cover bg-bottom rounded-2.5xl px-6 sm:px-10 py-7 sm:py-12 lg:py-7 flex flex-row gap-3 relative overflow-hidden bg-[#F1B0C9]"
        >
          ...
          <div class="relative z-10 flex flex-col gap-3 w-[80%] sm:w-[55%] justify-center">
            <h3 class="xs-max:text-2xl text-[32px] sm:text-product font-medium text-white">
              Акции <span class="text-[#b784b6]">Daigo</span>
            </h3>
            <p class="text-sm sm:text-2xl text-white my-0 sm:mb-4 lg:my-4 leading-snug">
              Актуальная информация<br></br>о скидках и акциях
            </p>
            <NuxtLink
              to="/akcii"
              class="text-white inline-flex items-center gap-2 text-sm sm:text-2xl font-normal transition duration-300 group"
            >
              Перейти к акциям
              <img
                src="/icons/arrow.svg"
