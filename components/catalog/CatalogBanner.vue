<template>
  <section class="w-full rounded-2xl">
    <div class="relative w-full xs-max:h-40 h-44 sm:h-48 lg:h-60 rounded-2xl overflow-hidden">
      <picture>
        <!-- mobile -->
      ...
      <div class="relative z-10 px-4 md:px-6 lg:px-10 py-4 lg:py-8 text-white">
        ...
        <NuxtLink
          ...
          class="inline-flex w-[64%] sm:w-[40%] lg:w-[30%] justify-center items-center gap-2 border border-white hover:bg-white hover:text-black rounded-lg px-2 py-1 md:py-2 xs-max:text-sm text-base md:text-xl tracking-wide transition duration-300"
        >
          {{ banner.buttonText }}
        </NuxtLink>
      </div>
