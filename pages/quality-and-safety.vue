...
const documents = ref<DocItem[]>([
  {
    ...
    src: '/media-s3/materials/sgr-daigo-lux.pdf',
    tag: 'СГР',
  },
  {
    id: 'sgr-daigo-5-10ml',
    ...
    src: '/media-s3/materials/sgr-daigo-5ml-10ml.pdf',
    tag: 'СГР',
  },
  {
    ...
    src: '/media-s3/materials/ds-daigo-dent-valid-until-2030-07-21.pdf',
    tag: 'ДС',
  },
  {
    id: 'ds-shampoo-2028',
    ...
    src: '/media-s3/materials/ds-shampoo-valid-until-2028-05-16.pdf',
    tag: 'ДС',
  },
  {
    id: 'sgr-pril-brainy',
    ...
    src: '/media-s3/materials/sgr-pril-daigo-brainy.pdf',
    tag: 'СГР',
  },
  {
    id: 'sgr-pril-dermic',
    ...
    src: '/media-s3/materials/sgr-pril-daigo-dermic.pdf',
    tag: 'СГР',
  },
  {
    id: 'sgr-pril-jointic',
    ...
    src: '/media-s3/materials/sgr-pril-daigo-jointic.pdf',
    tag: 'СГР',
  },
  {
    ...
    src: '/media-s3/materials/sgr-lactis-zoo-300.pdf.pdf',
    tag: 'СГР',
  },
  {
    ...
    src: '/media-s3/materials/sgr-tamotsu-3-years.pdf',
    tag: 'СГР',
  },
