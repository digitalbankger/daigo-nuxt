...
import { isEvolutionProductSlug } from "~/constants/evolution";
  ...
  <BaseContainer>
    <div v-if="product">
      ...
      <template v-else>
        ...
        <EvolutionProductSections v-if="isEvolutionProductPage" />
        ...
        >
          ...
          >
            ...
            >
              Как выбрать<span
                class="ms-1 rounded-md px-3 py-1 text-black bg-[#C3FF00]"
            ...
            <Button
              tp="/articles"
              variant="outline"
              class="!text-white !border-white hover:!text-black hover:bg-white !text-xs md:!text-lg !px-2 h-8 md:h-12 w-40 md:w-60"
            >
              Перейти к статьям
            </Button>
          </div>
