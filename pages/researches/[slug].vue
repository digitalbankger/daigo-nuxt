...
<template>
  <BaseContainer>
    ...
    >
    <img src="/images/subscription-product.png" alt="Banner" class="hidden md:block absolute z-0 right-0" />
    <img src="/images/subscription-left.png" alt="Banner" class="hidden md:block absolute z-0 left-0" />
    <img src="/images/subscription-product-mob.png" alt="Banner" class="block md:hidden absolute  z-0 right-0" />
    <img src="/images/subscription-left-mob.png" alt="Banner" class="block md:hidden absolute z-0 left-0" />
