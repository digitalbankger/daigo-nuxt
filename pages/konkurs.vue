...
useSeoMeta({
  title: 'Новогодний конкурс на Daigo.ru',
  description: 'Промо-страница акции: розыгрыш призов.',
  ogTitle: 'Новогодний конкурс на Daigo.ru',
  ogDescription: 'Розыгрыш призов.',
...
<BaseContainer>
  <img
    ...
    class="block absolute  top-32 sm:-top-40 inset-0 w-full"
    alt=""
  />  
  ...
  <main class="bonusopad">
    ...
    class="hidden sm:block absolute w-[100px] sm:w-[400px] -left-[12%] -top-[30%] z-0 -scale-x-100"
    alt=""
  />  
                <img
    src="/images/new-year/konkurs-toy.png"
    class="block absolute w-[150px] sm:w-[900px] right-0 sm:-right-[25%] top-[52%] sm:-top-[5%]"
    alt=""
  />  
...
>
  ...
  >
    ПРИЗОВ
          ...
          <img
    src="/images/new-year/konkurs-head.png"
    class="w-full relative z-20"
    alt=""
  />

        
        <p class="relative z-20 font-mont uppercase text-[16px] sm:text-[35px] font-medium mt-10 mb-4">Новогодняя лотерея</p>
        <div class="relative z-20 font-mont text-sm sm:text-[26px] leading-tight font-light w-full sm:w-9/12">
          <div class="">
            <p class="mb-8">
              Мы не ограничились одним Бонусопадом и объявляем большой розыгрыш призов, результаты которого подведем уже 16 Января в 16:00!

            </p>
            <p class="mb-8">
              Чтобы принять участие достаточно совершить покупку на сумму 10 000 рублей и в вашем личном кабинете появится уникальный номер билета, который сделает вас участником розыгрыша. Мы дарим вам по одному билету за каждые потраченные на нашем сайте 10 000 рублей - больше билетов, больше шансов! 
            </p>
            <p class="mb-8">
              Итоги розыгрыша будут подведены в нашем <a href="https://t.me/daigoru" target="_blank" class="underline">Телеграм канале</a> 16 Января в 16:00 по московскому времени и опубликованы на этой странице.
            </p>
            <a href="/konkurs-policy" class="mb-10 underline">
              Подробные условия акции.
            </a>

            <p class="relative z-20 font-mont uppercase text-[16px] sm:text-[35px] font-medium mt-10 mb-4">Новогодняя лотерея</p>
            <p class="mb-8">
              На этот праздник мы разыгрываем ценные наборы, к каждому из которых прилагается маленький сюрприз от бренда Daigo.
            </p>
            <ol class="list-decimal ps-10 space-y-6 my-20 mb-40">
              <li>Daigo Lux & Daigo Dent</li>
              <li>Tamotsu & Daigo Dent</li>
              <li>Daigo 10 & Daigo Dent</li>
            </ol>
          </div>
        </div>
      </div>
