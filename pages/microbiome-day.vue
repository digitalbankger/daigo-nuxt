...
//   description:
//     "Акция Daigo ко Дню микробиома: оставьте фото- или видеоотзыв о продукте.",
//   ogTitle: "День микробиома Daigo — подарки за отзывы",
//   ogDescription: "Расскажите о своём опыте Daigo, приложите фото или видео.",
//   ogType: "website",
...
useSeoMeta({
  ...
  description:
    "Оставьте отзыв о продукции Daigo. Расскажите о своём опыте использования и при желании приложите фото или видео.",
  ogTitle: "Оставить отзыв о Daigo",
  ogDescription: "Расскажите о своём опыте использования продукции Daigo.",
  ogType: "website",
  ogUrl: "https://daigo.ru/microbiome-day",
});
  ...
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        description: "Страница для отправки отзывов о продукции Daigo.",
        publisher: {
          "@type": "Organization",
          name: "Daigo",
          url: "https://daigo.ru",
...
//         //   description:
//         //     "Фото- и видеоотзывы участвуют в акции. Подарок открывается после модерации.",
    ...
    <main class="micro-page">
      <section class="micro-page__hero">
        <div class="micro-page__hero-content">
          ...
          <h1 class="font-haido">Ваш отзыв — это подарок для нас</h1>
          <p>
            Расскажите о своём опыте с Daigo. Ваш отзыв поможет другим сделать
            выбор.
          </p>
          <div class="micro-page__actions">
            <button
              type="button"
              class="micro-page__primary"
      ...
      <section
        id="rules"
        class="micro-page__reward-grid"
        aria-label="Форматы отзывов"
      >
        <article class="micro-page__reward-card micro-page__reward-card_big">
          <span>Видеоотзыв</span>
          <!-- <strong>Скидка 20% + Dent</strong> -->
          <p>
            Снимите короткое видео с продуктом и расскажите, почему выбрали
            Daigo.
          </p>
          <button type="button" @click="isReviewOpen = true">
            Отправить видео
          </button>
        </article>
      ...
      <!--     <p> -->
      <!--       Ко Дню микробиома мы собираем живые отзывы без сложных обещаний. Нам -->
      <!--       важны реальные истории людей, которые уже знакомы с продуктами -->
      <!--       Daigo. -->
      <!--     </p> -->
      <!--   </div> -->
      <!--   <ul> -->
      ...
      <section class="micro-page__game-block">
        <div>
          ...
          <p>
            Сыграйте в мини-игру: ловите вредные бактерии каплей Daigo и
            наполняйте баночку энергии. Чем больше заполнение — тем приятнее
            подарок.
          </p>
        </div>
      ...
      <section class="micro-page__cta">
        ...
        <p>
          Выберите товар, прикрепите фото или видео и отправьте отзыв прямо с
          телефона.
        </p>
        <button
          type="button"
...
.micro-page__cta {
  ...
  background:
    ...
    #f8fbff;
  box-shadow: 0 20px 60px rgba(242, 67, 145, 0.1);
}
...
.micro-page__hero {
  ...
  min-height: 520px;
  align-items: center;
  background: url("/images/promotions/microbiome-day-hero.png") right center /
    100% no-repeat;
...
.micro-page__reward-card button {
  ...
  color: #fff;
  box-shadow: 0 18px 40px rgba(242, 67, 145, 0.25);
}
...
.micro-page__secondary {
  border: 1px solid rgba(242, 67, 145, 0.22);
...
.micro-page__ribbon {
  ...
  background:
    ...
    linear-gradient(135deg, rgba(79, 142, 255, 0.26), rgba(255, 255, 255, 0.78));
  filter: blur(0.1px);
...
.micro-page__gift {
  ...
  width: 190px;
  height: 150px;
  border: 2px solid rgba(242, 67, 145, 0.46);
  border-radius: 24px;
  background: linear-gradient(135deg, #fff, #eef4ff);
  box-shadow: 0 28px 70px rgba(79, 142, 255, 0.18);
  transform: rotate(8deg);
}
...
.micro-page__card {
  ...
  padding: 22px 24px;
  box-shadow: 0 26px 64px rgba(79, 142, 255, 0.16);
...
.micro-page__game-jar {
  ...
  height: 250px;
  overflow: hidden;
  border: 3px solid rgba(242, 67, 145, 0.42);
  border-top-width: 14px;
  border-radius: 40px 40px 28px 28px;
  background: rgba(255, 255, 255, 0.74);
  box-shadow:
    inset 0 0 0 5px rgba(255, 255, 255, 0.8),
    0 24px 44px rgba(242, 67, 145, 0.18);
}
...
@media (max-width: 767px) {
  ...
  .micro-page__hero {
    ...
    background: url("/images/promotions/microbiome-day-hero-mobile.png") center
